...
const [selectedCategory, setSelectedCategory] = useState("miete");
          ...
          <div className="container">
            <div className="hero-content">
              <div className="hero-text">
                <h1 className="hero-title">Mach den ersten Schritt zu deiner finanziellen Freiheit</h1>
                <button className="cta-button" id="ctaButton">Jetzt loslegen</button>
              </div>
              <div className="hero-image">
                <img src="/hero-image.png" alt="Mann am Schreibtisch" className="hero-illustration-img" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="cards-grid">
              <a href="#geld-verstehen" className="finance-card finance-card-link">
                ...
                <div className="card-footer">
                  ...
                  <p>Lerne die Grundlagen unseres Finanzsystems kennen und verstehe, wie Geld funktioniert. Erfahre, wie du fundierte finanzielle Entscheidungen treffen kannst.</p>
                </div>
              </a>
              <a href="#budgetplanung" className="finance-card finance-card-link">
                ...
                <div className="card-footer">
                  <h3>Budgetplanung</h3>
                  <p>Erstelle deine persönliche Budgetplanung und behalte den Überblick über deine Einnahmen und Ausgaben. So kannst du gezielt sparen und deine Finanzen im Griff behalten.</p>
                </div>
              </a>
              <a href="#schulden-vermeiden" className="finance-card finance-card-link">
                <div className="card-image">
                  <img src="/schulden-vermeiden-karte.png" alt="Schulden vermeiden" className="card-image-img" />
                </div>
                <div className="card-footer">
                  <h3>Schulden vermeiden</h3>
                  <p>Lerne, wie du Schulden vermeidest und deine Finanzen unter Kontrolle behältst. Erfahre praktische Tipps für einen verantwortungsvollen Umgang mit Geld.</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="container">
            <div className="geld-content-wrapper">
              <div className="geld-illustration">
                <img src="/geld-verstehen-seite.png" alt="Geld verstehen Illustration" className="geld-illustration-img" />
              </div>
            ...
            <div className="back-button-container">
              <a href="#grundlagen" className="back-button">← Zurück zu Grundlagen</a>
            </div>
          </div>
        </section>
    ...
    <div className="budget-content-wrapper">
      ...
      <div className="budget-text-content">
        ...
        <div className="budget-text-flow">
                  ...
                  <p>
                    <strong>1. Einnahmen erfassen:</strong><br />
                    Beginne damit, alle deine monatlichen Einnahmen zu notieren. Dazu gehören dein
                    Gehalt, Nebeneinkünfte, Bafög oder andere regelmässige Einnahmequellen.
                  </p>
                  <p>
                    <strong>2. Ausgaben kategorisieren:</strong><br />
                    Teile deine Ausgaben in Kategorien ein: Miete, Lebensmittel, Versicherungen,
                    Transport, Freizeit, Sparen und Notreserve. So siehst du auf einen Blick,
                    wofür dein Geld verwendet wird.
                  </p>
                  <p>
                    <strong>3. Verhältnisse bestimmen:</strong><br />
                    Plane, wie viel Prozent deines Einkommens für jede Kategorie vorgesehen ist.
                    Eine gute Faustregel: 30% Wohnen, 15% Lebensmittel, 10% Versicherungen,
                    20% Sparen und Notreserve, 25% für den Rest.
                  </p>
                  <p>
                    <strong>4. Überprüfen und anpassen:</strong><br />
                    Regelmässige Kontrollen sind wichtig. Überprüfe monatlich, ob du dein Budget
                    einhältst und passe es bei Bedarf an deine Lebenssituation an.
                  </p>
                  <p>
                    Budgetplanung ist klar strukturiert und machbar - Schritt für Schritt kannst
                    du so deine finanzielle Situation verbessern und langfristig mehr Kontrolle
                    gewinnen.
                  </p>
                </div>
              </div>
            ...
            <div className="back-button-container">
              <a href="#grundlagen" className="back-button">← Zurück zu Budgetplanung</a>
              <a href="#budget-erstellen" className="back-button" style={{marginLeft: '1rem'}}>Mein Budget erstellen →</a>
            </div>
          </div>
        </section>

        {/* Budget erstellen Seite */}
        <section id="budget-erstellen" className="budget-erstellen-section">
          <div className="container">
            ...
            <p className="budget-erstellen-subtitle">Erstelle deine persönliche Budgetplanung und behalte den Überblick über deine Finanzen</p>
            ...
            <div className="budget-form-wrapper">
              <div className="budget-form-container">
                ...
                <div className="form-group">
                  ...
                  <input type="number" id="einnahmen" placeholder="z.B. 3000" min="0" step="0.01" />
                </div>
                ...
                <div className="expenses-container" id="expensesContainer">
                  ...
                  />
                    ...
                    <button type="button" className="remove-expense-btn" style={{display: 'none'}}>×</button>
                  </div>
                </div>
                ...
                <button type="button" className="add-expense-btn" id="addExpenseBtn">+ Kategorie hinzufügen</button>
                ...
                <div className="form-actions">
                  <button type="button" className="save-budget-btn" id="saveBudgetBtn">Budget speichern</button>
                  <button type="button" className="load-budget-btn" id="loadBudgetBtn">Gespeichertes Budget laden</button>
                  <button type="button" className="clear-budget-btn" id="clearBudgetBtn">Zurücksetzen</button>
                </div>
              </div>
                ...
                <div className="pie-chart-container-custom">
                  <BudgetLiveCircle
                    categories={[
                      ...
                      { label: "Versicherungen", value: budget.versicherungen, color: "#7fb069" },
                      { label: "Transport", value: budget.transport, color: "#a8e08e" },
                      { label: "Sparen", value: budget.sparen, color: "#d4f5c9" },
                  ]}
                />


                  <div className="pie-legend-custom" id="pieLegendCustom"></div>
                </div>
                <div className="budget-warning" id="budgetWarning" style={{display: 'none'}}></div>
              </div>
            </div>

            <div className="back-button-container">
              <a href="#budgetplanung" className="back-button">← Zurück zu Budgetplanung</a>
            </div>
          </div>
        </section>

        {/* Schulden vermeiden Seite */}
        <section id="schulden-vermeiden" className="schulden-vermeiden-section">
          <div className="container">
            <h2 className="schulden-title">Schulden vermeiden</h2>
            <p className="schulden-subtitle">Lerne, wie du Schulden vermeidest und deine Finanzen unter Kontrolle behältst</p>
            <div className="infographics-grid">
              <div className="infographic-card">
                <div className="infographic-icon">💸</div>
                <h3>Nicht alles direkt ausgeben</h3>
                <p>
                  Behalte immer einen Puffer für unvorhergesehene Ausgaben. Eine Notreserve von
                  mindestens drei Monatsgehältern schützt dich vor unerwarteten Situationen und
                  verhindert, dass du Schulden aufnehmen musst. Plane regelmässig einen Teil deines
                  Einkommens für Notfälle ein.
                </p>
              </div>
              <div className="infographic-card">
                <div className="infographic-icon">📊</div>
                ...
                <p>
                  Führe regelmässig Buch über deine Ausgaben. So behältst du den Überblick und
                  erkennst schnell, wo du Geld sparst kannst. Nutze Apps oder ein einfaches
                  Haushaltsbuch, um alle Einnahmen und Ausgaben zu dokumentieren und monatlich
                  zu überprüfen.
                </p>
              </div>
              <div className="infographic-card">
                ...
                <p>
                  Warte 24 Stunden vor grösseren Käufen. Oft verschwindet der Wunsch danach, und
                  du kannst eine durchdachtere Entscheidung treffen. Erstelle eine Wunschliste und
                  priorisiere deine Ausgaben, bevor du Geld ausgibst. So vermeidest du unnötige
          ...
          <div className="container">
            <div className="community-social">
              ...
              <div className="social-links">
                ...
                <a href="#" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="Discord">
                ...
                <a href="#" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
        ...
        <section id="feedback" className="feedback-section">
          <div className="container">
            ...
            <p className="feedback-subtitle">Wir freuen uns über deine Meinung und Anregungen</p>
            
            <form className="feedback-form" id="feedbackForm">
              <div className="form-row">
                <div className="form-group">
                  <label htmlFor="feedbackName">Name</label>
                  <input type="text" id="feedbackName" placeholder="Dein Name" />
                </div>
                <div className="form-group">
                  <label htmlFor="feedbackEmail">E-Mail</label>
                  <input type="email" id="feedbackEmail" placeholder="deine.email@beispiel.de" />
                </div>
              </div>
              
              <div className="form-group">
                <label htmlFor="feedbackRating">Wie zufrieden bist du mit unserer Website?</label>
                <div className="rating-container">
                  <input type="radio" id="rating5" name="rating" value="5" />
                  <label htmlFor="rating5" className="rating-label">⭐</label>
                  <input type="radio" id="rating4" name="rating" value="4" />
                  <label htmlFor="rating4" className="rating-label">⭐</label>
                  <input type="radio" id="rating3" name="rating" value="3" />
                  <label htmlFor="rating3" className="rating-label">⭐</label>
                  <input type="radio" id="rating2" name="rating" value="2" />
                  <label htmlFor="rating2" className="rating-label">⭐</label>
                  <input type="radio" id="rating1" name="rating" value="1" />
                  <label htmlFor="rating1" className="rating-label">⭐</label>
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                <textarea id="feedbackMessage" rows={6} placeholder="Teile uns deine Gedanken mit..." required></textarea>
              </div>
              
              <div className="form-actions-feedback">
                <button type="submit" className="submit-feedback-btn">Feedback absenden</button>
                <button type="reset" className="reset-feedback-btn">Zurücksetzen</button>
              </div>
              
              <div className="feedback-message" id="feedbackMessageEl" style={{display: 'none'}}></div>
            </form>

            {/* Feedback-Anzeige */}
            <div className="feedbacks-display">
              <h3 className="feedbacks-title">Feedback von Benutzern</h3>
              <div className="feedbacks-container" id="feedbacksContainer">
                <p className="no-feedback">Noch kein Feedback vorhanden. Sei der Erste!</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="footer-content">
            ...
            <div className="footer-social">
              ...
              <div className="footer-social-links">
                ...
                <a href="#" className="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="Discord">
